...
if ischar(settings.margin)
    if strcmp(settings.margin, 'tight') || strcmp(settings.margin, 'small')
        margin = [0.01 + settings.font_size / settings.size(1), ...
        0.01 + settings.font_size / settings.size(2)];
    elseif strcmp(settings.margin, 'normal') || strcmp(settings.margin, 'middle')
        margin = [0.05 + settings.font_size / settings.size(1), ...
        0.05 + settings.font_size / settings.size(2)];
